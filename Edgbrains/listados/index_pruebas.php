...
<html lang="es">
	<head>
		...
		<meta name="author" content="ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩukasz Holeczek">
			...
			<div class="row-fluid">
      						...
      						<div class="col-md-4">
								<fieldset>
									<div class="control-group">
										<label class="control-label" for="selectError">Año</label>
										<div class="controls">
								...
								<div class="col-md-4">										
									...
									<div class="controls">
										<label>
											<input type="checkbox"> Requiere Atención Especial
									    </label>
									</div>
									<div class="controls">
										<label>
				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							<table id="lista" class="table table-striped table-bordered bootstrap-datatable datatable">
								<thead>
									<tr>
										<th>ID</th>
										<th>Nombre</th>
								...
								$res=mysql_query("select * from Verano2014 LIMIT 1000",$con);
								while($fila=mysql_fetch_array($res)){
								
								?>
									<tr>
										<td><?php echo $fila['IdUsuario']; ?></td>
										<td><?php echo $fila['Nombre']; ?>, <?php echo $fila['Apellido']; ?> <?php echo $fila['SegundoApellido']; ?></td>
										<td class="center"><?php echo $fila['FechaSolicitud']; ?></td>
										<td class="center"><?php echo $fila['Duraci√≥n']; ?></td>
										<td class="center"><?php echo $fila['CursoSolicitado']; ?></td>
										<td class="center">
										...
										<td class="center"><?php if ($fila['RequiereAtenci√≥nEspecial']!="") {?><i class="icon-exclamation-sign" title="<?php echo $fila['RequiereAtenci√≥nEspecial']; ?>"></i><?php }?>></td>
										<td class="center">
