							...
							<table id="lista" class="table table-striped table-bordered bootstrap-datatable datatable">
								...
								?>
									<tr>
										...
										<td><?php echo $fila['nombre']; ?>, <?php echo $fila['apellidos']; ?> <?php echo $fila['apellidos2']; ?></td>
										<td class="center"><?php echo $fila['fecha_solicitud']; ?></td>
										<td class="center"><?php echo $fila['duracion']; ?></td>
										<td class="center">
